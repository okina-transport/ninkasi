...
/* Trigger export stop places by Kakka */
export const REQUEST_EXPORT_STOP_PLACES_ALL_PROVIDERS = 'REQUEST_EXPORT_STOP_PLACES_ALL_PROVIDERS';
export const REQUEST_EXPORT_STOP_PLACES_BY_PROVIDER = 'REQUEST_EXPORT_STOP_PLACES_BY_PROVIDER';
export const REQUEST_EXPORT_STOP_PLACES_ONE_PROVIDER = 'REQUEST_EXPORT_STOP_PLACES_ONE_PROVIDER';
export const SUCCESS_EXPORT_STOP_PLACES_ALL_PROVIDERS = 'SUCCESS_EXPORT_STOP_PLACES';
export const ERROR_EXPORT_STOP_PLACES_ALL_PROVIDERS = 'ERROR_EXPORT_STOP_PLACES';
export const SUCCESS_EXPORT_STOP_PLACES_BY_PROVIDER = 'SUCCESS_EXPORT_STOP_PLACES_BY_PROVIDER';
export const ERROR_EXPORT_STOP_PLACES_BY_PROVIDER = 'ERROR_EXPORT_STOP_PLACES_BY_PROVIDER';
export const SUCCESS_EXPORT_STOP_PLACES_ONE_PROVIDER = 'SUCCESS_EXPORT_STOP_PLACES_ONE_PROVIDER';
export const ERROR_EXPORT_STOP_PLACES_ONE_PROVIDER = 'ERROR_EXPORT_STOP_PLACES_ONE_PROVIDER';
export const SUCCESS_DELETE_STOP_PLACES_BY_PROVIDER = 'SUCCESS_DELETE_STOP_PLACES_BY_PROVIDER';
export const ERROR_DELETE_STOP_PLACES_BY_PROVIDER = 'ERROR_DELETE_STOP_PLACES_BY_PROVIDER';
export const REQUEST_DELETE_STOP_PLACES_BY_PROVIDER = 'REQUEST_DELETE_STOP_PLACES_BY_PROVIDER';
