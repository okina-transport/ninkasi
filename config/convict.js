...
module.exports = new Promise(function (resolve, reject) {
  var conf = convict({
    ...
    eventsBaseUrl: {
      ...
      format: "url",
      default: "http://localhost:8888/services/events/",
      env: "EVENTS_BASE_URL"
    },
    nabuEventsBaseUrl: {
      doc: "Base URL for for Events API including slash",
